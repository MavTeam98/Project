/*
 * Sachini_Dimingulage-GPA calculator First trial 29/05/2020
 */
package gpacal;
...
public class GPACalculator {
	...
	public static void main(String[] args) {
		System.out.println("Welcome to GPA Calculator! ");
          ...
          for(int i = 0; i < 4; i++)//Assigning 4 class grades to be entered 
          {
          ...
          switch(lettergrd)
          {//Letting the end user enter both capital and simple letters 
